...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
      ...
      //��mCache�õ�bitmap������˿��Ը�дImageCache�����ͼƬ���������棬����ԭ�е�LruCache���һ�������û���
      ...
      //ͬһ��ӽ�map���ϣ��Է������request�Ƿ������������磬���Խ�Լ��Դ
    ...
    private void batchResponse(String cacheKey, BatchedImageRequest request) {
        ...
        if (mRunnable == null) {
            ...
            // Post the runnable.
            // mHandler��Ӧ��looper��MainLooper����˱�MainLooper.loop()�õ���message���ʸ�runnable���������߳���ִ�У�
            //ˢ�½��沼��
